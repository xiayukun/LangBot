...
TENANT_TABLE_COLUMNS: dict[str, str] = {
    ...
    'notification_targets': 'workspace_uuid',
    'notification_jobs': 'workspace_uuid',
    'notification_attempts': 'workspace_uuid',
    'agent_connectors': 'workspace_uuid',
    'agent_conversations': 'workspace_uuid',
    'agent_messages': 'workspace_uuid',
    'agent_cursors': 'workspace_uuid',
    'agent_invocations': 'workspace_uuid',
